...
if (isset($_POST['login'])) {
	...
	if (!empty($user) && !empty($pass)) {
		$query = "SELECT * FROM admin WHERE uemail='$uemail' AND apass='$pass'";
    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Recently Uploaded Properties</h2>
                    </div>
                    - <div class="col-md-6">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
                                    ...
                                    <div class="pl-2">
                                        ...
                                        <p>With years of experience in the real estate industry, we have developed a deep understanding of the market dynamics, trends, and customer needs. Our expertise allows us to provide valuable insights and guidance throughout your real estate journey.</p>
                                    </div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                    <i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
                                    <div class="pl-2">
                                        <h5 class="mb-3">Reliable and Trustworthy</h5>
                                        <p>We prioritize building trust with our users. Our platform is built on a foundation of transparency, integrity, and ethical practices. We strive to provide accurate and up-to-date information, ensuring that you can make informed decisions with confidence.</p>
                                    </div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                    <i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
                                    <div class="pl-2">
                                        <h5 class="mb-3">Verifiable Listings</h5>
                                        <p> We carefully curate and verify property listings to ensure their authenticity and accuracy. Our rigorous quality checks and verification processes help you avoid scams or misleading information, giving you peace of mind during your property search.</p>
                                    </div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
                                    <i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
                                    <div class="pl-2">
                                        <h5 class="mb-3">Professional Network</h5>
                                        <p>We have established strong relationships with reputable real estate agents, agencies, and industry professionals. Through our platform, you gain access to a reliable network of trusted professionals who can assist you throughout the buying, selling, or renting process.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> Connect with property owners, real estate agents, and other users through our built-in messaging system. Easily communicate and ask questions about properties, negotiate terms, and discuss details in a convenient and secure environment.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Access important documents and files related to properties directly through our platform. From property descriptions and floor plans to inspection reports and legal documents, all the information you need is easily accessible for thorough review.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p> Once you've found the perfect property, our application provides a straightforward process for acquiring it. From submitting offers and negotiating terms to completing necessary paperwork, our platform streamlines the transaction process, making it efficient and transparent.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                                    $query = mysqli_query($con, "SELECT count(state), property.* FROM property where state='Tanzania'");
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <h4 class="hover-text-primary text-capitalize">
                                            <a href="stateproperty.php?id=<?php echo $row['17'] ?>">
                                            <?php echo $row['state']; ?></a></h4>
                                        <span><?php
                                        $total = $row[0];
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                                    $query = mysqli_query($con, "SELECT count(state), property.* FROM property where state='Kenya'");
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                                    $query = mysqli_query($con, "SELECT count(state), property.* FROM property where state='Zanzibar'");
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a></h4>
                                        <span><?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                                    $query = mysqli_query($con, "SELECT count(state), property.* FROM property where state='Rwanda'");
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17'] ?>"><?php echo $row['state']; ?></a></h4>
                                        <span><?php
